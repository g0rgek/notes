...
Получается, что при использовании value в range, происходит разыменование указателя по индексу. Указатель [nil](nil.md), получаем `nil pointer dereference`.
```go
package main
...
![Pasted image 20251130132627.png](Pasted%20image 20251130132627.png.md)
