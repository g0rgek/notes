...
```
Он принимает [slice](../types/slice.md) байт и возвращает кол-во прочитанных байт или ошибку.
...
Чтобы этого не было, лучше передавать `[]byte` в функцию и записывать в него. Такой подход позволит хранить слайс на стеке:
```go
package main
