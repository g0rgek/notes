...
```
- При повторном закрытии закрытого канала будет [паника](../2.1%20panic%20и%20recover.md#panic).
...
Почему чтение и запись в nil chan не приводит к [панике](../2.1%20panic%20и%20recover.md#panic)?
